    ...
    <div className="bg-background min-h-screen text-foreground overflow-hidden">
      ...
      <section className="py-32 px-6 max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-6 md:gap-8">
          ...
          <Link href="/collections/wall-sculptures" className="group block col-span-1 md:col-span-8 relative overflow-hidden h-[600px] bg-card" data-testid="card-collection-wall-sculptures">
